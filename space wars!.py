...
SPACE_AUDIO = pygame.mixer.music.load(os.path.join("Assets","space.mp3"))
...
def yellow_handle_movement(keys_pressed, yellow):
    ...
    if keys_pressed[pygame.K_UP] and yellow.y - VEL > 0: # UP
            yellow.y -= VEL 
    if keys_pressed[pygame.K_DOWN] and yellow.y + VEL + yellow.height < HEIGHT + 1: # DOWN
            yellow.y += VEL
...
def main():
    ...
    yellow = pygame.Rect(1000, 300, SPACESHIP_WIDTH, SPACESHIP_HEIGHT)
